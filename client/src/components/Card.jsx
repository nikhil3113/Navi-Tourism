        ...
        <div className="max-w-sm h-full bg-gray-800  dark:bg-[#e5e7eb] border border-gray-800 rounded-lg shadow ">
          ...
          <div className="p-5 h-full flex flex-col justify-between">
            ...
            <div className="flex justify-between items-end">
              <Link to={route}>
                <button className=" mt-10 inline-flex items-center px-3 py-2 text-[16px] font-semibold text-center dark:text-black text-white bg-blue-700 rounded-lg hover:bg-blue-800 hover:dark:bg-gray-500 focus:ring-4 focus:outline-none  dark:bg-[#b5b9be]  ">
                  {buttonName}
                  <svg

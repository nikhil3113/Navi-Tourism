        ...
        >
          ...
          <div className="flex flex-col my-5">
            {loading ? (
              ...
              <>
                <label htmlFor="iframe" className="font-semibold mb-2">
                  Google Map Iframe (src code)
                </label>
                <textarea
                  required
                  name="iframe"
                  placeholder="Only Enter Src from iframe (embeded link)"
                  value={iframe}
          ...
          <div className="flex flex-col my-5">
            {loading ? (
              ...
              <>
                <label htmlFor="distance" className="font-semibold mb-2">
                ...
                <input
                  ...
                  value={distFromStn}
                  onChange={(e) => setDistFromStn(e.target.value)}
                  className="border border-gray-300 bg-slate-200 p-2 rounded-lg focus:outline focus:ring-blue-700 focus:border-blue-700"
                />
              </>
            )}
